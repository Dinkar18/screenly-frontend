    ...
    <PublicRoute>
      ...
      <div className="hidden md:flex flex-col justify-between p-10 bg-zinc-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-3xl font-bold text-white mb-4">"The magic of cinema is not what you see, but what you feel."</h2>
          <p className="text-zinc-400">Book your tickets for the latest blockbusters in premium IMAX theaters today.</p>
        </div>
      </div>
