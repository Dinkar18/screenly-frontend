    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col justify-between p-10 bg-zinc-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-3xl font-bold text-white mb-4">"Secure your premier experience."</h2>
          <p className="text-zinc-400">We take your security seriously so you can focus on the movie.</p>
        </div>
      </div>
